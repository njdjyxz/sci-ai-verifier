...
WORKFLOW_TOOLS = ("load_submitted_skill", "read_snapshot_file", "commit_claim_manifest",
                  ...
                  "commit_demo_plan", "record_demo_observation")
...
class Dispatcher:
    ...
    def _execute(self, name, arguments, state):
        if state["profile"] == "demo" and name in {"commit_demo_plan", "record_demo_observation", "write_report_card"}:
            from . import demo
        ...
        if (state["profile"] == "verification" and state["run_state"] == "active"
